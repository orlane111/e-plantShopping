...
function ProductList({ onHomeClick }) {
    ...
    useEffect(() => {
        // Mettre à jour addedToCart en fonction des articles dans le panier
        const cartState = {};
    ...
    const handleAddToCart = (plant) => {
        dispatch(addItem({
            ...
            quantity: 1 // Initialiser la quantité à 1 lors de l'ajout
        }));
    };
    ...
    return (
        <div>
            ...
            {showCart && <CartItem onClose={handleContinueShopping} />}
                                ...
                                {category.plants.map((plant, plantIndex) => (
                                    <div key={plantIndex} className="product-card">
                                        ...
                                        <div className="product-details">
                                            ...
                                            >
                                                {addedToCart[plant.name] ? 'Dans le panier' : 'Ajouter au panier'}
                                            </button>
                                        </div>
                                    </div>
                                ))}
